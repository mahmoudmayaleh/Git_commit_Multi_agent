# 🤖 Three-Agent Git Commit Writer Pipeline

An intelligent, automated pipeline that generates high-quality conventional Git commit messages from code diffs using a multi-agent system powered by OpenChat-3.5 7B LLM.
