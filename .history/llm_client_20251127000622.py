"""
LLM Client for OpenChat-3.5

This module provides a unified interface for interacting with OpenChat-3.5,
supporting both local inference and API-based access.
"""
